...
parser.add_argument('--resume', default='/media/think/data1/ljh/MS-FAST/Imagenet/output/train/20240821-153241-vitsnn-224/checkpoint-245.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--checkpoint-hist', type=int, default=310, metavar='N',
