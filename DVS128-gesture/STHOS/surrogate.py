...
class qlSigmoid(SurrogateFunctionBase):
    def __init__(self, alpha=4.0, spiking=True):
        super().__init__(alpha, spiking)
    ...
    def cuda_codes(self, y: str, real_spike_seq:str, dtype: str):
        return cfunction.qlsigmoid_backward(y=y, real_spike_seq = real_spike_seq, alpha=self.alpha, dtype=dtype)
