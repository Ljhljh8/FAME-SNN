...
parser.add_argument('-c', '--config', default='Tiny-Imagenet.yml', type=str, metavar='FILE',
...
parser.add_argument('--input-size', default=None, nargs=3, type=int,
                    metavar='N N N',
                    help='Input all image dimensions (d h w, e.g. --input-size 3 64 64), uses model default if empty')
...
def main():
    ...
    model = create_model(
        ...
        depths = args.depths, sr_ratios = 1,STHOS=args.STHOS,
    )
    ...
    dataset_eval = create_dataset(
        ...
        batch_size=args.batch_size, transform=test_transform)
