...
parser.add_argument('-data-dir', metavar='DIR', default="/home/think/Downloads/tiny_imagenet_200/",
...
parser.add_argument('--clip-grad', type=float, default=2.0, metavar='NORM',
...
def train_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            output = model(input,float(last_idx+1))
