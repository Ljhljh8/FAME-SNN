...
def parse_args():
    ...
    parser.add_argument('--TET', default=False, help='TET')
    ...
    parser.add_argument('--data-path', default='/home/think/cifar10_dvs_data/', help='dataset')
    ...
    parser.add_argument('--opt', default='adamp', type=str, metavar="OPTIMIZER", help='Optimizer (default: "adamw")')
    ...
    # hyperparam_train
    parser.add_argument('--alpha-end-step', type=float, default=25.0 * 562.0,
                        help='alpha-end-step')
...
def train_one_epoch(model, criterion, optimizer, data_loader, device, epoch, print_freq, scaler=None, T_train=None,
                    aug=None, trival_aug=None, mixup_fn=None, args=None):
    model.train()
...
def main(args):
    ...
    output_dir_txt = os.path.join(output_dir, f'stopepoch{args.alpha_end_step}')
    ...
    start_time = time.time()
    records = []  # add to save the epoch acc
    ...
    for epoch in range(args.start_epoch, num_epochs):
        ...
        train_loss, train_acc1, train_acc5 = train_one_epoch(
            ...
            train_snn_aug, train_trivalaug, mixup_fn, args=args)
