...
parser.add_argument('-c', '--config', default='cifar10dvs4221.yml', type=str, metavar='FILE',
...
parser.add_argument('--STHOS', type=float, default=30.0, metavar='PCT',
                    help='Dropout rate (default: 0.)')
...
def main():
    ...
    setup_default_logging(log_path=f"./logs/training_{datetime.now().strftime('%Y%m%d_%H%M%S')}_sthos_{args.STHOS}.log")
    if args.log_wandb:
        if has_wandb:
