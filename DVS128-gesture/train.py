...
parser.add_argument('-c', '--config', default='dvs128.yml', type=str, metavar='FILE',
                    help='YAML config file specifying default arguments')

parser = argparse.ArgumentParser(description='PyTorch cifar10dvs Training')
parser.add_argument('--STHOS', type=int, default=2, metavar='layer',
...
def main():
    ...
    model = create_model(
        'MS_FAST',
        pretrained=False,
        drop_mlp=args.drop_mlp,
        attn_drop_rate=args.attn_drop_rate,
        drop_path_rate=args.drop_path_rate,
        drop_out_sps=args.drop_out_sps,
        drop_block_rate=None,
        img_size_h=args.img_size, img_size_w=args.img_size,
        patch_size=args.patch_size, embed_dims=args.dim, num_heads=args.num_heads,
        mlp_ratios=args.mlp_ratio, in_channels=2, num_classes=args.num_classes,
        depths=args.depths, STHOS=args.STHOS, alpha_init=args.alpha_init, sr_ratios=1,
    )
